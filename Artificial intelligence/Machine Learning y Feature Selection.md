...
- ## ¿Qué es la Feature engineering?
	- Similar a la [Selección de Características][Machine Learning y Feature Selection#Feature Selection] Donde se elimina las redundancias y las irrelevancias para ayudar a que los modelos sean más rápidos y eficientes, la **Feature engineering puede ayudar a agregar nuevas características**
