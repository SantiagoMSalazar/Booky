...
<p class="noteBox">Dos personas pueden compartir el mismo nombre, dirección y fecha de nacimiento pero siguen siendo persosns diferentes. </p>
...
- #### Mean Absolute Error
	...
	- $MAE=\frac{\Sigma_{i=1}^{total\ de\ errores}}{total\ de\ datos}$
	- 
...
- ## Split: Training Set y Testing Set
	...
	- Para este caso los datos se dividen en 3: **Entrenamiento, validación y pruebas**
...
## Resumen
![](Pasted%20image%2020230620112205.png)
