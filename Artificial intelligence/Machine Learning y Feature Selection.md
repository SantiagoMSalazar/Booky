...
- Generalmente los datos duplicados suelen ser **Falsos Positivos**.
	- <p style="border-color: rgb(0,150,100)">Dos personas pueden compartir el mismo nombre, dirección y fecha de nacimiento pero siguen siendo persosns diferentes. </div>
	- 
