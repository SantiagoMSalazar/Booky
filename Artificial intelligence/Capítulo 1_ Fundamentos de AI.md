...
- ### Evaluación del modelo - Evaluate model
	- Fedback del proceso.
## Concepto
Al diseñar los algoritmos inteligentes es necesario entender, limpiar y organizar la base de datos debido a que **No suelen estar limpios**. Es necesario comprender los datos para explorarlos y visualizarlos debido a que e